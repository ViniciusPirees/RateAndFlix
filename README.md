...
O objetivo principal deste projeto foi criar um site na plataforma web voltado para o mundo do entretenimento e cultura pop, especialmente para filmes. O site permite que os usuários publiquem suas críticas sobre os filmes que assistiram, tanto positivas quanto negativas. Essas críticas são disponibilizadas para que outros usuários possam ler e decidir se querem assistir ao filme ou não, além de obterem recomendações de outros filmes e séries. Além disso, o site oferece as últimas notícias do mundo do entretenimento e cultura pop. E além disso, o site possibilita aos usuários a criação de listas de filmes.
